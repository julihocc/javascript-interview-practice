...
testPhrase("^[b-yB-Y]+$")("Bee zapp Crow Eagle Zorro mouse Ape you")
console.log("🚀 ~ file: app.js ~ line 49 ~ testPhrase("^[b-yB-Y]+$")("Bee zapp Crow Eagle Zorro mouse Ape you")", testPhrase("^[b-yB-Y]+$")("Bee zapp Crow Eagle Zorro mouse Ape you"))
