...
// F
const html = "Is <b>ccc</b> <b>cococo</b> <b>4 < -1/12</b> true? The <b>answer</b> will <em>surprise</em> you."
const regexForF = new RegExp('<(\\w+)>^((?1coco).)*$</\\1>', 'g')
const testF = html.match(regexForF)
