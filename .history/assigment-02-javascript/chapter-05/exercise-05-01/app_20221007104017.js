    ...
    name = name,
        ...
        this.getClientsInfo = function () {         
            ...
            for(let id in clients){
                console.log(clients[id].retrieveInfo());;
            }
        }
}
...
function Client(bank, id, name, balance) {
    ...
    this.transferMoney = function (id, amount) {
        ...
        const propietary = this;
        const beneficiary = bank.getClientById(id);
        ...
        if (amount <= balance) {
            ...
            console.log("****\n Propietary Info")
            propietary.retrieveInfo()

            console.log("****\n Beneficiary info")
            beneficiary.retrieveInfo()

            propietary.retrieveMoney(amount);
            beneficiary.depositInOwnAccount(amount);
