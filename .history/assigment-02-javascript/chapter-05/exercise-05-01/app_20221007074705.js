...
baz.addClient(001, "Michael S", 250000);
baz.addClient(002, "Ani Carmona", 250000);
console.log(baz.clients);
console.log(baz.getAllClients());

const anita = baz.getClientById(001) 
console.log(anita.getName())
console.log(anita.getBalance())